...
const WordsModule = (() => {
  ...
  const MISSING_LETTER_DATA = [
    ...
    ['H_LZ',  'O','HOLZ', 1], ['G_LD',  'O','GOLD', 1], ['MO_D',  'N','MOND', 1],
    ...
    ['HOS_',  'E','HOSE', 1], ['K_SE',  'Ä','KÄSE', 1], ['L_CH',  'O','LOCH', 1],
    ['M_HL',  'E','MEHL', 1], ['MU_D',  'N','MUND', 1], ['N_ST',  'E','NEST', 1],
    ...
    ['BR_CKE','Ü','BRÜCKE',2], ['K_STE', 'Ü','KÜSTE', 2], ['SCH_F', 'A','SCHAF', 2],
  ...
  const SORT_WORDS = [
    ...
    'PINGUIN','DELFIN','SCHLANGE','LEHRERIN','KLASSE','FENSTER','BLUME',
  ...
  const OPPOSITE_PAIRS = [
    ...
    ['glatt','rau'],      ['gerade','krumm'],     ['scharf','mild'],
    ['süß','sauer'],      ['roh','gekocht'],
    ['alt','jung'],       ['arm','reich'],        ['stark','schwach'],
    ['gesund','krank'],   ['schön','hässlich'],   ['schlau','dumm'],
    ...
    ['Tag','Nacht'],      ['Sommer','Winter'],    ['Frühling','Herbst'],
