...
const WordsModule = (() => {
  ...
  function wasRecent(id, key) {
    return (recentKeys[id] || []).includes(key);
  }
  ...
  const MISSING_LETTER_DATA = [
    ...
    ['SCHUL_', 'E', 'SCHULE', 3],
    ['SCH_FF', 'I', 'SCHIFF', 3],
    ['FL_GZEUG', 'U', 'FLUGZEUG', 3],
    ['F_HRRAD', 'A', 'FAHRRAD', 3],
    ['BLEI_TIFT', 'S', 'BLEISTIFT', 3],
    ['SCH_RE', 'E', 'SCHERE', 3],
    ['TASCH_', 'E', 'TASCHE', 3],
    ['FENS_ER', 'T', 'FENSTER', 3],
    ['SP_NNE', 'I', 'SPINNE', 3],
    ['SCHNEC_E', 'K', 'SCHNECKE', 3],
    ['EL_FANT', 'E', 'ELEFANT', 3],
    ['GIR_FFE', 'A', 'GIRAFFE', 3],
    ['PING_IN', 'U', 'PINGUIN', 3],
    ['DEL_IN', 'F', 'DELFIN', 3],
    ['SCHLANG_', 'E', 'SCHLANGE', 3],
    ['L_HRERIN', 'E', 'LEHRERIN', 3],
    ['KL_SSE', 'A', 'KLASSE', 3],
    ['H_USAUFGABE', 'A', 'HAUSAUFGABE', 3],
    ['FR_HSTÜCK', 'Ü', 'FRÜHSTÜCK', 3],
    ['MITTAG_SSEN', 'E', 'MITTAGESSEN', 3],
    ['AB_NDBROT', 'E', 'ABENDBROT', 3],
    ['K_NSTLER', 'Ü', 'KÜNSTLER', 3],
    ['TH_ATER', 'E', 'THEATER', 3],
    ['ZI_KUS', 'R', 'ZIRKUS', 3],
    ['B_LLON', 'A', 'BALLON', 3],
    ['REGENB_GEN', 'O', 'REGENBOGEN', 3],
    ['GEW_TTER', 'I', 'GEWITTER', 3],
    ['SCHULT_R', 'E', 'SCHULTER', 3],
    ['FR_HLING', 'Ü', 'FRÜHLING', 3],
    ['S_MMER', 'O', 'SOMMER', 3],
    ['H_RBST', 'E', 'HERBST', 3],
    ['W_NTER', 'I', 'WINTER', 3],
    ['OKT_BER', 'O', 'OKTOBER', 3],
    ['DEZ_MBER', 'E', 'DEZEMBER', 3],
    ['JAN_AR', 'U', 'JANUAR', 3],
    ['F_BRUAR', 'E', 'FEBRUAR', 3],
    ['M_RCHEN', 'Ä', 'MÄRCHEN', 3],
    ['Z_UBER', 'A', 'ZAUBER', 3],
    ['KR_NKENHAUS', 'A', 'KRANKENHAUS', 3],
    ['F_UERWEHR', 'E', 'FEUERWEHR', 3],
    ['FL_GHAFEN', 'U', 'FLUGHAFEN', 3],
    ['B_HNHOF', 'A', 'BAHNHOF', 3],
    ['BIBL_OTHEK', 'I', 'BIBLIOTHEK', 3],
    ['SP_EGEL', 'I', 'SPIEGEL', 3],
    ['SCHL_SSEL', 'Ü', 'SCHLÜSSEL', 3],
    ['GESCH_NK', 'E', 'GESCHENK', 3],
    ['SCHM_TTERLING', 'E', 'SCHMETTERLING', 3],
    ['MAR_ENKÄFER', 'I', 'MARIENKÄFER', 3],
    ['SCHNEEM_NN', 'A', 'SCHNEEMANN', 3],
    ['OST_RN', 'E', 'OSTERN', 3],
    ['WEIHN_CHTEN', 'A', 'WEIHNACHTEN', 3],
  ...
  const CATEGORY_ITEMS = [
    ...
    { w: 'Birke', cat: 'Pflanze' },
    { w: 'Blume', cat: 'Pflanze' },
    { w: 'Kaktus', cat: 'Pflanze' },
    { w: 'Moos', cat: 'Pflanze' },
    { w: 'Farn', cat: 'Pflanze' },
    { w: 'Efeu', cat: 'Pflanze' },
    { w: 'Sonnenblume', cat: 'Pflanze' },
    { w: 'Nelke', cat: 'Pflanze' },
    { w: 'Lilie', cat: 'Pflanze' },
    { w: 'Bambus', cat: 'Pflanze' },
    { w: 'Palme', cat: 'Pflanze' },
    { w: 'Eibe', cat: 'Pflanze' },
    { w: 'Ahorn', cat: 'Pflanze' },
    { w: 'Löwenzahn', cat: 'Pflanze' },
    { w: 'Vergissmeinnicht', cat: 'Pflanze' },
    ...
    { w: 'Silber', cat: 'Farbe' },
    { w: 'Violett', cat: 'Farbe' },
    { w: 'Dunkelblau', cat: 'Farbe' },
    { w: 'Hellgrün', cat: 'Farbe' },
    { w: 'Dunkelrot', cat: 'Farbe' },
    { w: 'Hellblau', cat: 'Farbe' },
    // Kleidung
    { w: 'Hemd', cat: 'Kleidung' },
    { w: 'Hose', cat: 'Kleidung' },
    { w: 'Rock', cat: 'Kleidung' },
    { w: 'Kleid', cat: 'Kleidung' },
    { w: 'Mantel', cat: 'Kleidung' },
    { w: 'Jacke', cat: 'Kleidung' },
    { w: 'Schuhe', cat: 'Kleidung' },
    { w: 'Socken', cat: 'Kleidung' },
    { w: 'Mütze', cat: 'Kleidung' },
    { w: 'Schal', cat: 'Kleidung' },
    { w: 'Pullover', cat: 'Kleidung' },
    { w: 'Bluse', cat: 'Kleidung' },
    { w: 'Strumpf', cat: 'Kleidung' },
    { w: 'Handschuh', cat: 'Kleidung' },
    { w: 'Schürze', cat: 'Kleidung' },
    { w: 'Gürtel', cat: 'Kleidung' },
    { w: 'Kappe', cat: 'Kleidung' },
    { w: 'Stiefel', cat: 'Kleidung' },
    { w: 'Badehose', cat: 'Kleidung' },
    { w: 'Badeanzug', cat: 'Kleidung' },
    { w: 'Schlafanzug', cat: 'Kleidung' },
    { w: 'Regenmantel', cat: 'Kleidung' },
    { w: 'Weste', cat: 'Kleidung' },
    // Fahrzeug
    { w: 'Auto', cat: 'Fahrzeug' },
    { w: 'Bus', cat: 'Fahrzeug' },
    { w: 'Zug', cat: 'Fahrzeug' },
    { w: 'Flugzeug', cat: 'Fahrzeug' },
    { w: 'Schiff', cat: 'Fahrzeug' },
    { w: 'Fahrrad', cat: 'Fahrzeug' },
    { w: 'Motorrad', cat: 'Fahrzeug' },
    { w: 'Lkw', cat: 'Fahrzeug' },
    { w: 'Straßenbahn', cat: 'Fahrzeug' },
    { w: 'Hubschrauber', cat: 'Fahrzeug' },
    { w: 'Rakete', cat: 'Fahrzeug' },
    { w: 'Boot', cat: 'Fahrzeug' },
    { w: 'U-Boot', cat: 'Fahrzeug' },
    { w: 'Roller', cat: 'Fahrzeug' },
    { w: 'Skateboard', cat: 'Fahrzeug' },
    { w: 'Traktor', cat: 'Fahrzeug' },
    { w: 'Krankenwagen', cat: 'Fahrzeug' },
    { w: 'Feuerwehrauto', cat: 'Fahrzeug' },
    { w: 'Taxi', cat: 'Fahrzeug' },
    { w: 'Bagger', cat: 'Fahrzeug' },
    { w: 'Kutsche', cat: 'Fahrzeug' },
    { w: 'Segelboot', cat: 'Fahrzeug' },
    // Lebensmittel
    { w: 'Brot', cat: 'Lebensmittel' },
    { w: 'Milch', cat: 'Lebensmittel' },
    { w: 'Apfel', cat: 'Lebensmittel' },
    { w: 'Banane', cat: 'Lebensmittel' },
    { w: 'Birne', cat: 'Lebensmittel' },
    { w: 'Kirsche', cat: 'Lebensmittel' },
    { w: 'Erdbeere', cat: 'Lebensmittel' },
    { w: 'Tomate', cat: 'Lebensmittel' },
    { w: 'Gurke', cat: 'Lebensmittel' },
    { w: 'Karotte', cat: 'Lebensmittel' },
    { w: 'Salat', cat: 'Lebensmittel' },
    { w: 'Käse', cat: 'Lebensmittel' },
    { w: 'Ei', cat: 'Lebensmittel' },
    { w: 'Butter', cat: 'Lebensmittel' },
    { w: 'Kuchen', cat: 'Lebensmittel' },
    { w: 'Keks', cat: 'Lebensmittel' },
    { w: 'Schokolade', cat: 'Lebensmittel' },
    { w: 'Bonbon', cat: 'Lebensmittel' },
    { w: 'Joghurt', cat: 'Lebensmittel' },
    { w: 'Saft', cat: 'Lebensmittel' },
    { w: 'Suppe', cat: 'Lebensmittel' },
    { w: 'Nudeln', cat: 'Lebensmittel' },
    { w: 'Reis', cat: 'Lebensmittel' },
    // Körperteil
    { w: 'Kopf', cat: 'Körperteil' },
    { w: 'Auge', cat: 'Körperteil' },
    { w: 'Ohr', cat: 'Körperteil' },
    { w: 'Nase', cat: 'Körperteil' },
    { w: 'Mund', cat: 'Körperteil' },
    { w: 'Zahn', cat: 'Körperteil' },
    { w: 'Zunge', cat: 'Körperteil' },
    { w: 'Hals', cat: 'Körperteil' },
    { w: 'Arm', cat: 'Körperteil' },
    { w: 'Hand', cat: 'Körperteil' },
    { w: 'Finger', cat: 'Körperteil' },
    { w: 'Bauch', cat: 'Körperteil' },
    { w: 'Rücken', cat: 'Körperteil' },
    { w: 'Bein', cat: 'Körperteil' },
    { w: 'Knie', cat: 'Körperteil' },
    { w: 'Fuß', cat: 'Körperteil' },
    { w: 'Zehe', cat: 'Körperteil' },
    { w: 'Schulter', cat: 'Körperteil' },
    { w: 'Ellbogen', cat: 'Körperteil' },
    { w: 'Stirn', cat: 'Körperteil' },
    { w: 'Wange', cat: 'Körperteil' },
    { w: 'Lippe', cat: 'Körperteil' },
    { w: 'Herz', cat: 'Körperteil' },
  ];
    ...
    sortLetters: {
      ...
      generate(difficulty) {
        ...
        do {
          ...
          attempts++;
        } while ((wasRecent('sortLetters', word) || shuffled.join('') === word) && attempts < 20);
    ...
    opposites: {
      ...
      generate(difficulty) {
        ...
        do {
          ...
          const others = OPPOSITE_PAIRS.filter((p) => p !== pair)
