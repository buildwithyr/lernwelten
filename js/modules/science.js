...
const ScienceModule = (() => {
  ...
  const KNOWLEDGE_QUESTIONS = [
    ...
    [
      ...
      ['Er fliegt weg', 'Er geht baden', 'Er hält Winterschlaf'],
      'Tiere',
      '🐻',
    ],
    ...
    [
      'Wie schützt sich ein Igel?',
      ['Er läuft weg', 'Er beißt', 'Er rollt sich zusammen'],
      'Tiere',
      '🦔',
    ],
    ...
    [
      ...
      ['Wegen des Mondes', 'Wegen der Sterne', 'Weil die Erde sich dreht'],
      'Weltraum',
      '🌞',
    ],
    ...
    [
      'Was ist ein Komet?',
      ['Ein Stern', 'Ein Planet', 'Ein Eisball mit Schweif'],
      'Weltraum',
      '☄️',
    ],
    [
      'Woher bekommt der Mond sein Licht?',
      ['Er leuchtet selbst', 'Von den Sternen', 'Von der Sonne'],
      'Weltraum',
      '🌕',
    ],
    [
      'Wie nennt man Reisende ins Weltall?',
      ['Piloten', 'Matrosen', 'Astronauten'],
      'Weltraum',
      '👨‍🚀',
    ],
    ...
    [
      ...
      ['Die Sonne explodiert', 'Es wird heiß', 'Der Mond verdeckt die Sonne'],
      'Weltraum',
      '🌑',
    ],
    [
      'Wie lange braucht die Erde für eine Runde um die Sonne?',
      ['1 Monat', '1 Woche', '1 Jahr'],
      'Weltraum',
      '🌍',
    ],
    ...
    [
      ...
      ['Am Mittag', 'Beim Regen', 'In der Nacht'],
      'Weltraum',
      '⭐',
    ],
    [
      'Welcher Stern ist der Erde am nächsten?',
      ['Der Mond', 'Der Mars', 'Die Sonne'],
      'Weltraum',
      '☀️',
    ],
    [
      'Was ist ein Asteroid?',
      ['Ein Stern', 'Ein Planet', 'Ein Gesteinsbrocken im Weltall'],
      'Weltraum',
      '🪨',
    ],
    ['Welcher Planet hat Ringe?', ['Erde', 'Mars', 'Saturn'], 'Weltraum', '🪐'],
    [
      'Was trägt ein Astronaut im Weltall?',
      ['Einen Schlafanzug', 'Eine Badehose', 'Einen Raumanzug'],
      'Weltraum',
      '👨‍🚀',
    ],
    [
      'Warum leuchten Sterne?',
      ['Sie spiegeln das Meer', 'Sie sind aus Gold', 'Sie sind sehr heiß und glühen'],
      'Weltraum',
      '⭐',
    ],
    // ── Natur ──
    [
      ...
      ['Es wird warm', 'Es verschwindet', 'Es wird zu Eis'],
      'Natur',
      '🧊',
    ],
    [
      'Was braucht eine Pflanze zum Wachsen?',
      ['Zucker', 'Salz', 'Wasser und Sonne'],
      'Natur',
      '🌱',
    ],
    ...
    [
      ...
      ['Ein See', 'Ein Fluss', 'Ein riesiger Berg aus Eis'],
      'Natur',
      '🧊',
    ],
    [
      'In welcher Jahreszeit werden die Blätter bunt?',
    ...
    [
      ...
      ['Alles friert ein', 'Alles verblüht', 'Die Natur erwacht'],
      'Natur',
      '🌸',
    ],
    ...
    [
      ...
      ['Durch Wind', 'Durch Blitz', 'Durch Sonne und Regen'],
      'Natur',
      '🌈',
    ],
    ...
    [
      'Was macht ein Baum mit seinen Blättern im Herbst?',
      ['Sie werden größer', 'Sie bleiben gleich', 'Er lässt sie fallen'],
      'Natur',
      '🍂',
    ],
    ...
    [
      ...
      ['Es pumpt Blut', 'Es verdaut Essen', 'Es denkt und steuert alles'],
      'Mensch',
      '🧠',
    ],
    ...
    [
      'Was machen wir beim Schlafen?',
      ['Wir rennen', 'Wir essen', 'Unser Körper erholt sich'],
      'Mensch',
      '😴',
    ],
    ...
    [
      ...
      ['Damit wir fliegen können', 'Damit die Haare glänzen', 'Unser Körper braucht Wasser'],
      'Mensch',
      '💧',
    ],
    ...
    [
      ...
      ['Sie denken', 'Sie schlafen', 'Sie bewegen den Körper'],
      'Mensch',
      '💪',
    ],
    ...
    [
      ...
      ['Zum Spielen', 'Zum Essen', 'Damit sich der Körper erholen kann'],
      'Mensch',
      '😴',
    ],
    [
      'Was ist ein Vitamin?',
      ['Ein Spielzeug', 'Ein Knochen', 'Ein Nährstoff für den Körper'],
      'Mensch',
      '🍎',
    ],
    [
      'Was sollst du nach dem Essen tun?',
      ['Schlafen', 'Fernsehen', 'Zähne putzen'],
      'Mensch',
      '🪥',
    ],
    // ── Wetter ──
    ...
    [
      'Was ist ein Blitz?',
      ['Starker Wind', 'Starker Regen', 'Ein heller Strahl beim Gewitter'],
      'Wetter',
      '⚡',
    ],
    ...
    [
      ...
      ['Ein Tier', 'Ein Berg', 'Ein sehr starker Wirbelsturm'],
      'Wetter',
      '🌀',
    ],
    ...
    [
      ...
      ['Ein Spiel', 'Ein Märchen', 'Sie sagt, wie das Wetter wird'],
      'Wetter',
      '📱',
    ],
    [
      'Womit schützt du dich vor Regen?',
      ['Mit einer Sonnenbrille', 'Mit Handschuhen', 'Mit einem Regenschirm'],
      'Wetter',
      '☔',
    ],
    [
      'Was ziehst du im Winter an?',
      ['Eine Badehose', 'Ein T-Shirt', 'Eine warme Jacke'],
      'Wetter',
      '🧥',
    ],
    [
      'Warum ist es im Winter kälter?',
      ['Weil der Mond näher ist', 'Wegen der Sterne', 'Weil die Sonne weniger scheint'],
      'Wetter',
      '❄️',
    ],
    ...
    [
      ...
      ['Es ist heiß', 'Es regnet stark', 'Wasser gefriert auf dem Boden'],
      'Wetter',
      '🧊',
    ],
    [
      'Welche Farben hat ein Regenbogen?',
      ['Nur Grau', 'Nur Schwarz und Weiß', 'Viele bunte Farben'],
      'Wetter',
      '🌈',
    ],
    ['Wann ist es draußen am hellsten?', ['In der Nacht', 'Am Abend', 'Am Mittag'], 'Wetter', '⛅'],
    [
      'Was brauchst du an einem sonnigen Sommertag?',
      ['Einen Wintermantel', 'Handschuhe', 'Sonnencreme'],
      'Wetter',
      '🧴',
    ],
    ...
    [
      ...
      ['Kein Wind', 'Es schneit', 'Viele Wolken am Himmel'],
      'Wetter',
      '⛅',
    ],
    ...
    [
      'Was ist ein Sturm?',
      ['Leichter Wind', 'Schwacher Regen', 'Sehr starker Wind'],
      'Wetter',
      '🌪️',
    ],
    [
      'Was passiert beim Sonnenuntergang?',
      ['Die Sonne geht auf', 'Es wird Mittag', 'Die Sonne geht unter'],
      'Wetter',
      '🌅',
    ],
    // Weitere Tiere
    ...
    [
      'Wie zeigen Bienen, wo Blumen sind?',
      ['Durch Bellen', 'Durch Singen', 'Durch Tanzen'],
      'Tiere',
      '🐝',
    ],
    [
      'Was ist ein Zugvogel?',
      ['Ein Hausvogel', 'Ein Meerestier', 'Ein Vogel, der im Winter wegfliegt'],
      'Tiere',
      '🦅',
    ],
    [
      'Wo lebt ein Pinguin?',
      ['In der Wüste', 'Im Dschungel', 'Dort, wo es sehr kalt ist'],
      'Tiere',
      '🐧',
    ],
    ['Was fressen Ameisen?', ['Nur Steine', 'Nur Sand', 'Fast alles'], 'Tiere', '🐜'],
    [
      'Wie schützt sich ein Stachelschwein?',
      ['Es beißt', 'Es läuft weg', 'Mit seinen Stacheln'],
      'Tiere',
      '🦔',
    ],
    [
      'Welches Tier ist kein Fisch, lebt aber im Wasser?',
      ['Lachs', 'Forelle', 'Delfin'],
      'Tiere',
      '🐬',
    ],
    [
      'Was ist ein Winterschlaf?',
      ['Ein kurzes Schläfchen', 'Ein Spiel', 'Ein langer Schlaf im Winter'],
      'Tiere',
      '🐻',
    ],
    ...
    [
      'Was sind Fossilien?',
      ['Lebende Tiere', 'Junge Pflanzen', 'Versteinerte Reste alter Lebewesen'],
      'Natur',
      '🦕',
    ],
    ...
    [
      'Was ist eine Oase?',
      ['Ein Berg', 'Eine Stadt', 'Eine grüne Stelle in der Wüste'],
      'Natur',
      '🌴',
    ],
    [
      'Was ist Sauerstoff?',
      ['Ein Tier', 'Eine Pflanze', 'Ein Gas, das wir zum Atmen brauchen'],
      'Natur',
      '💨',
    ],
    [
      'Welches Wasser kann man trinken?',
      ['Meerwasser', 'Pfützenwasser', 'Leitungswasser'],
      'Natur',
      '🚰',
    ],
    // Weitere Weltraum
    [
      ...
      ['Ein Flugzeug', 'Eine Insel', 'Ein Labor im Weltraum'],
      'Weltraum',
      '🚀',
    ],
    [
      'Wie sieht der Vollmond aus?',
      ['Wie ein Stern', 'Wie eine Banane', 'Rund wie ein Ball'],
      'Weltraum',
      '🌕',
    ],
    [
      'Was ist eine Mondfinsternis?',
      ['Der Mond explodiert', 'Der Mond friert ein', 'Die Erde wirft einen Schatten auf den Mond'],
      'Weltraum',
      '🌑',
    ],
    [
      'Was sind Sternschnuppen?',
      ['Echte Sterne', 'Kleine Monde', 'Steinchen, die am Himmel verglühen'],
      'Weltraum',
      '🌠',
    ],
    [
      'Womit kann man Sterne genau beobachten?',
      ['Mit einer Lupe', 'Mit einem Mikroskop', 'Mit einem Teleskop'],
      'Weltraum',
      '🔭',
    ],
    // Mensch weitere
    ...
    [
      'Was ist das Skelett?',
      ['Alle Muskeln', 'Alle Haare', 'Alle Knochen zusammen'],
      'Mensch',
      '🦴',
    ],
    [
      'Warum ist Bewegung wichtig?',
      ['Sie macht müde', 'Sie macht hungrig', 'Sie hält den Körper gesund'],
      'Mensch',
      '🏃',
    ],
    // Noch mehr Natur
    [
      ...
      ['Eine Wolke', 'Ein Berg', 'Ein Zuhause für Meerestiere'],
      'Natur',
      '🐠',
    ],
    ...
    [
      ...
      ['Ein Gebirge', 'Eine Wüste', 'Ein dichter Wald mit vielen Tieren'],
      'Natur',
      '🌴',
    ],
    ...
    [
      ...
      ['Ein Astronaut', 'Ein Arzt', 'Ein Wetterforscher'],
      'Wetter',
      '🌤️',
    ],
    [
      'Bei welcher Temperatur friert Wasser?',
      ['Bei 10 Grad', 'Bei 100 Grad', 'Bei 0 Grad'],
      'Wetter',
      '🌡️',
    ],
    [
      'Was ist ein Sandsturm?',
      ['Regen mit Blumen', 'Schnee in der Wüste', 'Ein Sturm, der Sand aufwirbelt'],
      'Wetter',
      '🏜️',
    ],
    [
      'Was brauchst du bei Schnee an den Händen?',
      ['Eine Sonnenbrille', 'Sandalen', 'Warme Handschuhe'],
      'Wetter',
      '🧤',
    ],
      ...
      generate(difficulty) {
        const pool =
          difficulty === 1
            ...
            : difficulty === 2
              ? KNOWLEDGE_QUESTIONS.filter((q) =>
                  ['Tiere', 'Natur', 'Wetter', 'Mensch'].includes(q[2])
                )
              : KNOWLEDGE_QUESTIONS;
