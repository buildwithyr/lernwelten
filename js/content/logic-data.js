...
const LogicData = (() => {
  ...
  const MIRROR_PATTERNS = [
    { name: 'Baum',   cells: [[0,2],[1,1],[1,2],[2,0],[2,1],[2,2],[3,2],[4,2]] },
    { name: 'Herz',   cells: [[0,1],[1,0],[1,1],[1,2],[2,0],[2,1],[2,2],[3,1],[3,2],[4,2]] },
    { name: 'Haus',   cells: [[0,2],[1,1],[1,2],[2,0],[2,1],[2,2],[3,0],[3,2],[4,0],[4,2]] },
    { name: 'Blume',  cells: [[0,1],[0,2],[1,1],[1,2],[2,2],[3,2],[4,1],[4,2]] },
    { name: 'Krone',  cells: [[0,0],[0,2],[1,0],[1,1],[1,2],[2,0],[2,1],[2,2],[3,1],[3,2]] },
    { name: 'Stern',  cells: [[0,2],[1,1],[1,2],[2,0],[2,1],[2,2],[3,1],[3,2],[4,2]] },
  ];
